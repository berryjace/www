...
$_SESSION['tinybrowser']['sessionsecured'] = false; // enables session-based security (default is true)
$_SESSION['tinybrowser']['sessioncheck'] = 'mytinybrowser'; // name of session variable to check
...
$_SESSION['tinybrowser']['path']['root'] = '/uploads/'; // upload root directory
$_SESSION['tinybrowser']['path']['image'] = '/uploads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$_SESSION['tinybrowser']['path']['media'] = '/uploads/media/'; // Media files location
$_SESSION['tinybrowser']['path']['file']  = '/uploads/files/'; // Other files location
