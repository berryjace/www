...
//        }
    ...
    public function init() {
        ...
        $name->setLabel('Organization Name')
                ...
                ->setAttribs(array('size' => '50', 'class' => 'dtext', 'disabled'=> 'disabled'))->setRequired(false)
...
//                        ->setDisableLoadDefaultDecorators(true)
//                        ->setAttribs(array('size' => '50', 'class' => 'dtext'))->setRequired(true)
//                        ->addFilter('StripTags')->addFilter('StringTrim');
...
//        }
		...
		->setAttribs(array('class' => 'disableddd','disabled'=> 'disabled'))
                ->setDisableLoadDefaultDecorators(true)
                ->addMultiOptions($state_options);

        $contactPerson = new Zend_Form_Element_Text('contact_person');
        $contactPerson->setLabel('Agreement Notification Email')
                ->setDisableLoadDefaultDecorators(true)
                ->setAttribs(array('size' => '50', 'class' => 'dtext', 'disabled'=> 'disabled'))->setRequired(false)
                ->addFilter('StripTags')->addFilter('StringTrim');
