 ...
 * @author Masud
 */
class Client_NotificationController extends Zend_Controller_Action {
    ...
    /**
     * Function to show client notificatins
     * @author Masud
     * @copyright Blueliner Marketing
     * @version 0.1
     * @access public                                                  
    ...
    /**
     * Function to get notifications for client
     * @author Masud
     * @copyright Blueliner Marketing
     * @version 0.1
     * @access public
...
//        $params['vendor_id'] = $this->_helper->BUtilities->getLoggedInUser();
        ...
        $json = $this->em->getRepository("BL\Entity\Notification")->getNotificationDt($params);
        echo $json;
    }
