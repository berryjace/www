...
/**
 * Description of Apply4
 *
 * @author Masud
 */
class Vendor_Form_Apply4 extends Zend_Form {
    ...
    public function init() {
        ...
        $application_process->setDisableLoadDefaultDecorators(true)
                ...
                ->setValidators(array(array('NotEmpty', true, array('messages' => 'Please select at least one of the following.'))))
        ...
        $full_time_employee_num->setLabel('How many full time employees do you have?')
                ...
                ->setDecorators(array('ViewHelper'))
                ->setValidators(array(array('NotEmpty', true, array('messages' => 'Please enter number of employees.'))))
                ->setRequired(true)
                ->addFilter('StripTags')
                ->addFilter('StringTrim');
        ...
        $years_in_business->setLabel('')
                ...
                ->setDisableLoadDefaultDecorators(true)
                ->setDecorators(array('ViewHelper'))
                ->setValidators(array(array('NotEmpty', true, array('messages' => 'Please enter the business year.'))))
                ->setRequired(true)
                ->addFilter('StripTags')
                ->addFilter('StringTrim');
