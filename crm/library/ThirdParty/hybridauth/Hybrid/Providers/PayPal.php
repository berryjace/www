...
/**
 * Hybrid_Providers_PayPal class, wrapper for PayPal user accounts and hosted apps 
 */
class Hybrid_Providers_PayPal extends Hybrid_Provider_Model
{
	...
	* begin login step
	* 
	* PayPal_service must be "User" for PayPal user accounts service or "Apps" for PayPal hosted Apps
	* if chosen PayPal_service eq "Apps", PayPal_hosted_domain parameter will be required
	*
	* build an normalized OpenID url to autentify the user with selected PayPal_service openid identifier
	*/
	function loginBegin( )
	{ 
		...
		# redirect the user to the selected PayPal openid identifier authentification page, and exit 
