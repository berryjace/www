...
{ 
	...
	*/
	function initialize() 
	{
		...
		if ( $this->token( "oauth_access_token" ) )
		{
			$this->api->SetAccessToken( $this->token( "oauth_access_token" ) );
		}
	}
	...
	*/
	...
	{ 
		...
		$authorize_link = $this->api->AuthenticationLink( urlencode( $this->endpoint ) );
	...
	*/
	function loginFinish()
	{
		...
		$this->token( "oauth_access_token", $access_token ); 
