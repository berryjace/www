...
/**
 *
 * @Table(name="vendor_royalty_report_save")
 * @Entity(repositoryClass="BL\Entity\Repository\VendorRoyaltyReportSaveRepository")
 * @author Tanzim
 * @author Mahbub
 */
class VendorRoyaltyReportSave {
    ...
    private $year;
    /**
     * @Column(name="save_id", type="string", length=50, nullable=false)
     */
    private $save_id;
    /**
     * @Column(name="saved_from_tab", type="integer", length=1, nullable=false)
     */
    private $saved_from_tab;
    ...
    /**
     * @Column(name="sales_revenue", type="string", length=1, nullable=true)
     */
